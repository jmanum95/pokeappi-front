    ...
    return (
        <>
            <ul className={styles.list}>
                <li key="back"><p onClick={() => {if(pageNum > 1) pages(pageNum - 1); if(pageNum > 1)SetPageNum(pageNum - 1)}}
                className={styles.backorforw}>← Prev</p></li>
                ...
                className={styles.backorforw}>Next →</p></li>
            </ul>
        </>
    )
}