  ...
  switch (action.type) {
    ...
    case "FILTER_BY_TYPE":
      action.payload === "all"
        ...
        : (state.pokemons = state.pokemonsCopy.filter((p) =>
    ...
    case "FILTER_BY_ATTRIBUTE":
      if (action.payload === "weight")
        state.pokemons = state.pokemons.sort((a, b) => b.weight - a.weight);
      else if (action.payload === "height")
        state.pokemons = state.pokemons.sort((a, b) => b.height - a.height);
      else if (action.payload === "attack")
        state.pokemons = state.pokemons.sort((a, b) => b.attack - a.attack);
      else if (action.payload === "defense")
        state.pokemons = state.pokemons.sort((a, b) => b.defense - a.defense);
      else if (action.payload === "speed")
        state.pokemons = state.pokemons.sort((a, b) => b.speed - a.speed);
      else if (action.payload === "hp")
        state.pokemons = state.pokemons.sort((a, b) => b.hp - a.hp);
